...
from airflow.utils.trigger_rule import TriggerRule  # <-- corrected import
...
from src.email_function import send_email_via_smtp
...
dag = DAG(
    ...
    description="Airflow-project DAG Description",
    schedule="@daily",
    catchup=False,
    tags=["ml pipeline"],
